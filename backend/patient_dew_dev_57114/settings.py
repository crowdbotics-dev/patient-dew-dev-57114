"""
Django settings for patient_dew_dev_57114 project.
...
ROOT_URLCONF = 'patient_dew_dev_57114.urls'
...
WSGI_APPLICATION = 'patient_dew_dev_57114.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_dew_dev_57114 API",
    "DESCRIPTION": "API documentation for patient_dew_dev_57114 App",
    "VERSION": "v1",
}
